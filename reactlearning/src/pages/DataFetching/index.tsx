...
import { dataFetchingLessons } from "./lessons.ts";
...
export default function Home(_: HomeProps) {
    ...
    return (
        <div className={commonStyles.container}>
            <PageHeader title="State & Events" subtitle="Managing state in functional components." />

            <div className={commonStyles.vertical} aria-label="Lessons">
                {dataFetchingLessons.map((lesson, index) => {
